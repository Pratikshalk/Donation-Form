...
//     {
//         try{
//             await addDoc(dbref, {Name:name, Email:email, Address:address, Phone:phone});
...
//             <h2>Donation Form</h2>
//             <div className='box'>
//                 <input type='text' value={name} placeholder='Name' autoComplete='off' onChange={(e) => setName(e.target.value)}></input>
//                 <input type='email' value={email} placeholder='Email' autoComplete='off' onChange={(e) => setEmail(e.target.value)}></input>
//                 <input type='text' value={address} placeholder='Address' autoComplete='off' onChange={(e) => setAddress(e.target.value)}></input>
//                 <input type='text' value={phone} placeholder='Phone Number' autoComplete='off' onChange={(e) => setPhone(e.target.value)}></input>
...
// import DonationContractData from './DonationContract.json'; // Ensure proper ABI import
// import './form.css';
...
//       const contractAddress = '0xC07B21594e3cFD9a0a9F90908c949ec7294A61C9';  // Replace with your deployed contract address
